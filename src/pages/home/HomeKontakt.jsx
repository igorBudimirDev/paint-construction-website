...
const Home_kontakt = () => {
  return (
    <div className="kontakt h-screen bg-dark-gray-color flex justify-center items-center ">
      <div className="kontakt__wrapper h-[70%] bg-white px-10 flex justify-center">
        <div className="h-[80%] w-[100%] flex items-center flex-col">
          ...
          <div className="kontakt__content h-[100%] flex flex-col items-center text-center md:px-[20px] justify-around">
            <div className="kontakt__content--phone border-2 w-[100%] border-main-green p-2 flex flex-col items-center md:flex-row">
            ...
            <div className="kontakt__content--phone border-2 p-2 flex border-main-green flex-col items-center md:flex-row">
