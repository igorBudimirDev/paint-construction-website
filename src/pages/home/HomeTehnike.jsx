    ...
    <div className="container max-w-[100%] flex items-center justify-center bg-white">
      <div className="tehnike h-screen flex flex-col justify-center w-[80%] md:gap-9">
        <div className="tehnike__upper flex flex-col items-center justify-around md:items-start md:flex-row">
          ...
          <div className="tehnike__upper--text flex flex-col items-center justify-around md:h-[100%] md:justify-center md:items-center">
            <h4 className="text-main-green text-2xl md:text-4xl">Istinto</h4>
            <p className="text-center text-sm md:text-md lg:text-xl mobile:text-[10px]">
              Dekorativni materijal Istinto predstavlja jedinstvo
              <br />
              između prirode, arhitekture i dizajna, a svaki zid pretvara u
              unikatno umetničko delo. Ovaj proizvod na bazi kreča,
              <br />
